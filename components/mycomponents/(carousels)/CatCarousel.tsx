...
const CatCarousel = () => {
  return (
    <Carousel autoplay interval={7000} className="">
      ...
      <CarouselPrevious className="top-[63px] max-lg:hidden max-lg:size-7.5 md:right-4 lg:-right-10 max-lg:[&>*]:size-6" />
      <CarouselNext className="top-[63px] max-lg:hidden max-lg:size-7.5 md:left-4 lg:-left-12 max-lg:[&>*]:size-6" />
    </Carousel>
  );
};
