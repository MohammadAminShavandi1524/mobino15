...
interface FiltersModalColorFilterProps {
  colors: string[] | null;
  isColorFilterActive: boolean;
  setTempFilters: Dispatch<SetStateAction<TempfiltersProps>>;
}

const FiltersModalColorFilter = ({
  isColorFilterActive,
  colors,
  setTempFilters,
}: FiltersModalColorFilterProps) => {
  ...
  if (isFilterOpen)
    return (
      <div className="cursor-pointer border-b border-b-[#ced0d0]">
        ...
        <div className="grid gap-y-4 grid-cols-4 sm:grid-cols-6 s:grid-cols-5  lg:flex lg:flex-wrap lg:items-center lg:gap-x-1 lg:gap-y-2 px-[14px] pt-1 pb-3">
          {options.map((colorGroup) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={cn(
                    "flex size-[62px] lg:size-[50px] items-center justify-center rounded-[10px] border border-[#e0e0e2]",
                ...
                >
                  ...
                  colorGroup.label === "سیاه" ? (
                    ...
                    <div className={cn("grid size-12 lg:size-9 grid-cols-4 rounded-md")}>
                      <div
                        style={{
...
export default FiltersModalColorFilter;
