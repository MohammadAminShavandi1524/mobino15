    ...
    <AnimatePresence>
      {isMobileModalOpen && (
        <motion.div
          ...
          className="fixed top-0 right-0 z-[500] flex min-h-screen min-w-screen items-end justify-center bg-zinc-900/50 sm:hidden"
        >
          <motion.div
            key="modal"
            ...
            className="flex w-full flex-col rounded-t-xl bg-white p-4 py-6 shadow-[0px_1px_4px_rgba(0,0,0,0.08)]"
          >
            {/* header */}
